...
if(isset($_POST['add_item'])){
    ...
    $query = "INSERT INTO `inventory`(`part_number`, `serial_number`, `name`, `quantity`, `minimum`, `division`, `shelf`, `level`, `zone`, `depth`,`last_audited`, `creation_time`, `last_edited`, `note`) VALUES ('$part_number', '$serial_number', '$name', $quantity, $minimum, '$shelf', '$level', '$zone' ,'$depth','','$creation_time','$last_edited','$note')";
